...
Before the Day-14 it is possible to render the Project, but it is a bit more complicated. If you really need, that, read [About-All-Dings](<23.md#Day-23: Organizing Things Part-1>) to find out, how this works.
