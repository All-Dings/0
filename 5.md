...
Everytime, when Time and Date is important, we use the [Blog-Chain-Time](300000000.md) to specify the ordering of Events in a reasonable Way. 
...
### Comma-Separator for Comma-Numbers

We use the `,`-Character for Comma-Numbers, e.g. `0,99 Euro`.
