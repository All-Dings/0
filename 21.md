...
She pretends to me to not have understood my [Argumentation](600176.md), which of course cannot be [The-Truth](600140.md), because I know that she is not bad at all in [Mathematics](13000000.md).

After a Walk in [Harmony](60100.md) with [Soey](142000001.md), the next Day I meet [Sarah](151000002.md) together with her [Father](40000007.md) and try to explain them as well, that [Men](40080022.md) do *not* have more [Fun](60170.md) than [Women](40000010.md).

So let's assume we have a tiny [Universe](10000027.md) with only two Men **M1/M2** and two Women **W1/W2**, where **M1** has two Contacts with each of **W1/W2**, whereas **M2** has Zero-Contacts, then we can calculate the [Average-Ratio](12000060.md) **Women_per_Men** as Follows:
