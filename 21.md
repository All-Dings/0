...
Then we can calculate the _Fun_Count_per_Woman_ as Follows:

$$ Fun\_Count\_per\_Woman = Average(x_1,x_2) $$
...
Analogous to just now we now can also calculate the _Fun_Count_per_Men_ as Follows:

$$ Fun\_Count\_per\_Man = Average(x_1,x_2) $$
$$ =  \frac{\sum\limits_{i=1}^{2}{x_i}}{2} = \frac{x_1 + x_2}{2} = \frac{2 + 0}{2} = \frac{2}{2} = 1 $$

So for both Calculations the Reslut is One and therefore I proved my Hypothesis:

$$ Fun\_Count\_per\_Woman = Fun\_Count\_per\_Man $$

But I have to admit, that though in [Theory](7000001.md) this looks like [Correctness](600077.md), nevertheless in [Reality](40000.md) the unbalanced Distribution could lead to [Problems](600029.md), like [Loneliness](14000003.md) for _M2_ or [Overload](600177.md) for _M1_:
