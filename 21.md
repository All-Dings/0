...
To verify [The-Truth](600140.md) even more, we can also write a little [Python](9010003.md)-Program "Men-Women-Fun.py":
...
If we run the Program, we get the correct Result:
