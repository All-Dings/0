...
To verify [The-Truth](600140.md) even more, we can also write a little [Python](9010003.md)-Program "Men-Women-Fun.py", where we first define the [Average-Function](12000060.md):
...
```python
print(f'Avarage for Women: {Average_for_Women()}')
print(f'Avarage for Men  : {Average_for_Men()}')
```
...
Avarage for Women: 1.0
Avarage for Men  : 1.0
```

But I have to admit, that though in [Theory](7000001.md) this looks like [Correctness](600077.md), nevertheless in [Reality](40000.md) the unbalanced Distribution could lead to *real* [Problems](600029.md), like [Loneliness](14000003.md) for _M2_ or [Overload](600177.md) of _M1_:
