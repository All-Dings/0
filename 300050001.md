...
Besides the already mentioned [Zero-Energy](10000071.md), where perhaps never a [Measurement](10000022.md) could be found, there is another [Hypothesis](600028.md), which could save the [Engergy-Convervation-Law](10000017.md):

- The [Wave-Engergy](10000080.md) is tunneld into a [Parallel-Universe](10000075.md).

For a [Proove](600022.md) of this [Theory](10000060.md), we could use [Zero-Wave-Devices](20000021.md) to setup a [Communication](60061.md) with the [Aliens](40000031.md), who might live there.

There is already one known Case, where the [Engergy-Convervation-Law](10000017.md) is already violated, namely [Quantum-Fluctuations](10000096.md). If we can find there [Patterns](60112.md), that cannot be explained by [Stochastics](13005001.md), perhaps already [Living-Beings](40000016.md) are using [Zero-Wave-Devices](20000021.md), or even try to setup a [Communication](60061.md) with us.
